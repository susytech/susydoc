...
((("EVM (Susy Virtual Machine)","opcodes and gas consumption")))((("gas","EVM opcodes and gas consumption")))This appendix is based on the consolidation work done by the people of https://github.com/trailofbits/evm-opcodes as a reference for Susy VM (EVM) opcodes and instruction information licensed under the http://bit.ly/2zfrv0b[Apache License 2.0].
...
|`0x3d` |+RETURNDATASIZE+ |Pushes the size of the return data buffer onto the stack |http://bit.ly/2zaBcNe[SIP-211] |2

|`0x3e` |+RETURNDATACOPY+ |Copies data from the return data buffer to memory |http://bit.ly/2zaBcNe[SIP-211] |3
...
|`0xb0` |+JUMPTO+ |Tentative http://bit.ly/2Sx2Vkg[libevmasm has different numbers] | http://bit.ly/2CR77pu[SIP 615] |

|`0xb1` |+JUMPIF+ |Tentative |http://bit.ly/2CR77pu[SIP-615] |

|`0xb2` |+JUMPSUB+ |Tentative |http://bit.ly/2CR77pu[SIP-615] |

|`0xb4` |+JUMPSUBV+ |Tentative |http://bit.ly/2CR77pu[SIP-615] |

|`0xb5` |+BEGINSUB+ |Tentative |http://bit.ly/2CR77pu[SIP-615] |

|`0xb6` |+BEGINDATA+ |Tentative |http://bit.ly/2CR77pu[SIP-615] |

|`0xb8` |+RETURNSUB+ |Tentative |http://bit.ly/2CR77pu[SIP-615] |

|`0xb9` |+PUTLOCAL+ |Tentative |http://bit.ly/2CR77pu[SIP-615] |

|`0xba` |+GETLOCA+ |Tentative |http://bit.ly/2CR77pu[SIP-615] |

|`0xbb` - `0xe0` |Unused |- |- |

|`0xe1` |+SLOADBYTES+ |Only referenced in +pysusy+ |- |-

|`0xe2` |+SSTOREBYTES+ |Only referenced in +pysusy+ |- |-

|`0xe3` |+SSIZE+ |Only referenced in +pysusy+ |- |-
