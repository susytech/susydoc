...
The web3.js JavaScript library is a collection of modules that contain specific functionality for the Susy ecosystem, together with an Susy-compatible JavaScript API that implements the Generic JSON RPC spec.
