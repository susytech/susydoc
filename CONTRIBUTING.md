...
[![Gitter chat](https://badges.gitter.im/gitterHQ/gitter.png)](https://gitter.im/susydoc/Lobby)

This doc is developed collaboratively and openly, here on GitHub. We accept comments, contributions and corrections from all.
...
You can chat with the authors and editors on [Gitter chat](https://gitter.im/susydoc/Lobby).

## License and attribution

If you are sourcing a contribution from somewhere else, it must carry a compatible license. The doc will initially be released under a CC-BY-NC-ND license which means that contributions must be licensed under open licenses such as MIT, CC0, CC-BY, etc. You need to indicate the original source and original license, by including an asciidoc markup comment above your contribution, like this:
...
The best way to contribute to this doc is by making a pull request:

1. Login with your GitHub account or create one now
2. [Fork](https://github.com/susydoc/susydoc#fork-destination-box) the `susydoc` repository. Work on your fork.
...
7. Submit a pull request against the susydoc repository.

Here's a video tutorial to help you make your first pull request:

[![Susy Doc Pull Request Tutorial](https://img.youtube.com/vi/IBYHohWm_5w/0.jpg)](https://www.youtube.com/watch?v=IBYHohWm_5w)
...
Create a [new Issue](https://github.com/susydoc/susydoc/issues/new) now!

## Heading styles normalization across the doc

Adjust heading style in each section as follows:

1. Only the chapter/section should be level 2, everything else should be level 3 and below (level 1 is the doc title itself). Each asciidoc file should start with a "==" heading.
2. All lower case, except for first letter, proper nouns and acronyms. "What is this thing?", "What is the Susy sprocket?" "Who created the Susy Name Service (ENS)"
...
We are very grateful for the support of the entire Susy community. With your help, this will be a great doc that can help thousands of developers get started and eventually "master" Susy. Thank you!
