...
# https://raw.githubussrcontent.com/trailofbits/evm-opcodes/master/README.md
# from https://github.com/trailofbits/evm-opcodes

# ^[^|]*(\|[^|]*){3}$

ORIGIN_FILE=https://raw.githubussrcontent.com/trailofbits/evm-opcodes/master/README.md
