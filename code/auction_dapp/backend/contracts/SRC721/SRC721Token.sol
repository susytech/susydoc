...
import "./SRC721.sol";
import "./DeprecatedSRC721.sol";
import "./SRC721BasicToken.sol";
 ...
 */
contract SRC721Token is SRC721, SRC721BasicToken {
  // Token name
  ...
  */
  function SRC721Token(string _name, string _symbol) public {
    name_ = _name;
    symbol_ = _symbol;
  }
