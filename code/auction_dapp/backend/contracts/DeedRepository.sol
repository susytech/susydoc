...
import "./SRC721/SRC721Token.sol";

/**
 * @title Repository of SRC721 Deeds
 ...
 * to the repository.
 */
contract DeedRepository is SRC721Token {
    ...
    */
    function DeedRepository(string _name, string _symbol) 
        public SRC721Token(_name, _symbol) {}
    
    /**
    * @dev Public function to register a new deed
    * @dev Call the SRC721Token minter
